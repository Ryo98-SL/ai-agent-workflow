    ...
    <div className="space-y-4">
      <section>
        <div className="mb-2 flex items-center justify-between gap-3">
          <h3 className="text-xs font-semibold uppercase tracking-wide text-muted-foreground">Input Fields</h3>
          <Button
            variant="successSoft"
            size="sm"
            onClick={addField}
        ...
        {node.config.fields.length === 0 ? (
          <p className="rounded-md bg-muted p-3 text-sm text-muted-foreground">No Start inputs configured.</p>
        ) : (
